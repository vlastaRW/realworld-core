// DesignerViewFactoryChooseBestLayout.h : Declaration of the CDesignerViewFactoryChooseBestLayout
...
class ATL_NO_VTABLE CDesignerViewFactoryChooseBestLayout : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CDesignerViewFactoryChooseBestLayout, &CLSID_DesignerViewFactoryChooseBestLayout>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CDesignerViewFactoryChooseBestLayout)

BEGIN_CATEGORY_MAP(CDesignerViewFactoryChooseBestLayout)
	IMPLEMENTED_CATEGORY(CATID_DesignerViewFactory)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CDesignerViewFactoryChooseBestLayout)
...
OBJECT_ENTRY_AUTO(__uuidof(DesignerViewFactoryChooseBestLayout), CDesignerViewFactoryChooseBestLayout)
