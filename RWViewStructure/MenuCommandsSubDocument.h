// MenuCommandsSubDocument.h : Declaration of the CMenuCommandsSubDocument
...
class ATL_NO_VTABLE CMenuCommandsSubDocument :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CMenuCommandsSubDocument, &CLSID_MenuCommandsSubDocument>,
...
DECLARE_NO_REGISTRY()
DECLARE_CLASSFACTORY_SINGLETON(CMenuCommandsSubDocument)

BEGIN_CATEGORY_MAP(CMenuCommandsSubDocument)
	IMPLEMENTED_CATEGORY(CATID_DocumentMenuCommands)
END_CATEGORY_MAP()

BEGIN_COM_MAP(CMenuCommandsSubDocument)
...
private:
	static void GetSubDoc(ISubDocumentsMgr* a_pSDM, IConfig* a_pConfig, IOperationContext* a_pStates, IDocument** a_ppDoc);
};

OBJECT_ENTRY_AUTO(__uuidof(MenuCommandsSubDocument), CMenuCommandsSubDocument)
