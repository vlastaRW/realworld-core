            ...
            while((num_styles = ras.sweep_styles()) > 0)
            {
                ...
                else
                {
                    ...
                    if(sl_len)
                    {
                                ...
                                if(solid)
                                {
                                    ...
                                    for(;;)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            if(cover)
                                            {
												bl(colors, dst_covers, c, cover);
                                                //colors->add(dst_covers, c, cover);
                                                //colors->add(c, cover);
                                                //*dst_covers += cover;
                                            }
                                            ++colors;
                                ...
                                else
                                {
                                    ...
                                    for(;;)
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            if(cover)
                                            {
												bl(colors, dst_covers, *cspan, cover);
                                                //colors->add(dst_covers, *cspan, cover);
						...
						//{
						//	// demultiply coverage
						//	color_type* mix = mix_buffer + sl_start - min_x;
						//	cover_type* cover = cover_buffer + sl_start - min_x;
						//	for (unsigned i = 0; i < sl_len; ++i, ++mix, ++cover)
						//	{
						//		if (*cover && *cover != cover_full)
						//		{
						//			mix->r = mix->r*255/(*cover);
						//			mix->g = mix->g*255/(*cover);
						//			mix->b = mix->b*255/(*cover);
						//			mix->a = mix->a*255/(*cover);
						//			mix->demultiply();
						//		}
						//	}
						//}
