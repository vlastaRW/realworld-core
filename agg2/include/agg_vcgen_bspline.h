...
namespace agg
{
    ...
    public:
		...
		// Get point coordinates directly
		bool get(double at, double* x, double* y);

		int vertex_count() const { return m_src_vertices.size(); }
		void get_vertex(int i, double* x, double* nx, double* y, double* ny) const { m_spline_x.get_vertex(i, x, nx); m_spline_y.get_vertex(i, y, ny); }
